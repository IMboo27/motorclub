    ...
    <section class="contact-section">
        <div class="container">
            <div class="d-none d-sm-block mb-5 pb-4">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3982.0835889446885!2d98.69237217405805!3d3.5682384964059612!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30313059bc5c1dcd%3A0x4711e61bc0acbfcc!2sUniversitas%20Harapan%20Medan!5e0!3m2!1sid!2sid!4v1696495257632!5m2!1sid!2sid" width="1200" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>

            </div>
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">Tuliskan Disini</h2>
                </div>
                <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <textarea class="form-control w-100" name="pesan" id="pesan
                                        " cols="30" rows="9" onfocus="this.placeholder = ''"
                                        onblur="this.placeholder = 'Enter Message'" placeholder=" Pesan"></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                ...
                <div class="col-lg-3 offset-lg-1">
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <h3>Medan, Indonesia.</h3>
                            <p>Jalan Medan Belawan</p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                        <div class="media-body">
                            <h3>+62 82289107911</h3>
                            <p>Mulai pukul 09.00 - 19.00</p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-email"></i></span>
                        <div class="media-body">
                            <h3>whydmln1804@gmail.com</h3>
                            <p>Kabarkan Kapan Pun!</p>
                        </div>
                    </div>
                </div>
            </div>
