...
<html class="no-js" lang="zxx">
  ...
  <body>
    ...
    <main>
      ...
      <!--? Produk Area Start -->
      <section
        class="services-area pt-100 pb-150 section-bg"
          ...
          <div class="container">
            <div class="row align-items-end justify-content-between">
              ...
              <div class="col-xl-2 col-lg-2 col-md-3">
                <a href="produk.php" class="btn wantToWork-btn f-right"
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
              <div class="single-cat text-center mb-50">
                <div class="cat-icon">
                  ...
                  <img
                    src="assets/img/gallery/stiker.jpg"
                    alt=""
                    width="200px"
                    height="130px"
                  />
                ...
                <br />
                <div class="cat-cap">
                  <h5><a href="produk.php">Stiker</a></h5>
                  <p>
                    Pasang stiker dari kami agar tampilan lebih keren dan
                    menarik.
                  </p>
                  <br />
                  <br />
                ...
                <div class="img-cap">
                  <a href="produk.php" class=""
                    >Lihat selengkapnya <i class="ti-arrow-right"></i
                  ></a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-6">
              <div class="single-cat text-center mb-50">
                <div class="cat-icon">
                  <!-- <i class="flaticon-clock"></i> -->
                  <img
                    src="assets/img/gallery/baju.jpeg"
                    alt=""
                    width="200px"
                    height="140px"
                  />
                ...
                <br />
                <div class="cat-cap">
                  <h5><a href="produk.php">Baju</a></h5>
                  <p>
                    Terlihat lebih gagah dengan memakai outfit kami, lebih
            ...
            <div class="col-lg-4 col-md-4 col-sm-6">
              <div class="single-cat text-center mb-50">
                <div class="cat-icon">
                  <!-- <i class="flaticon-clock"></i> -->
                  <img
                    src="assets/img/gallery/mesin.png"
                    alt=""
                    width="200px"
                  />
                </div>
                <br />
                <div class="cat-cap">
                  <h5><a href="produk.php">Mesin</a></h5>
                  <p>
                    Sebagai penikmatan motor anda agar lebih nyaman digunakan
                    dan juga lebih terawat.
                  </p>
                </div>
                <div class="img-cap">
                  <a href="produk.php" class=""
      ...
      <section
        class="services-area pt-100 pb-150 section-bg"
        data-background="assets/img/gallery/m4.jpg"
      >
        <!--? Want To work -->
                  ...
                  <div class="h1-testimonial-active">
                    ...
                    <div class="single-testimonial">
                      <div class="testimonial-caption">
                        <p>
                          Produk yang dijual sangat bagus, murah dan berkualitas
                          tinggi. ahitan rapi tidak gampang kusut dan tidak
                          menyerap panas.
                        </p>
                        <div class="rattiong-caption">
                          <span style="color: white"
                            >Yuyuk wahyudi<span>Pembeli Pakaian</span>
                          </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="single-testimonial">
                      <div class="testimonial-caption">
                        <p>
                          Motor saya lebih stabil dan lebih nyaman digunakan
                          daripada sebelumnya. Sungguh hebat mereka bisa
                          mengcustom mesin dari mesin motor saya dan saya sangat
                          puas.
                        </p>
                        <div class="rattiong-caption">
                          <span style="color: white"
                            >fernando<span>Pemeliharaan Mesin Motor</span>
                          </span>
                        </div>
                      </div>
                    </div>
                    <div class="single-testimonial">
                      <div class="testimonial-caption">
                        <p>
                          Wow... Keren... <br />
                          gambar yang didesain sangat cantik dan indah sertas
                          tidak membosankan jika dilihat terus-terusan.
                        </p>

                        <div class="rattiong-caption">
                          <span style="color: white"
                            >Dicky<span>Penikmat Desain</span>
                          </span>
                        </div>
                      </div>
                    </div>
