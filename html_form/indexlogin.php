...
<html dir="ltr" lang="en">
  <head>
    ...
    <!-- Custom CSS -->
    <link
      href="../assets_form/libs/flot/css/float-chart.css"
      rel="stylesheet"
    />
    <!-- Custom CSS -->
  ...
  <body>
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
                  ...
                  <h6 class="text-white">Visi & Misi</h6>
                </div>
              </div>
            </div>
            <!-- Column -->
              ...
              <div class="card">
                ...
                <div class="comment-widgets scrollable">
                  ...
                  <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                      <img
                        src="../assets_form/images/users/5.jpg"
                        alt="user"
                        width="50"
                        class="rounded-circle"
                      />
                        ...
                        <ul class="list-style-none assignedto">
                          ...
                          <li class="assignee">
                            <img
                              class="rounded-circle"
                              width="40"
                              src="../assets_form/images/users/2.jpg"
                              alt="user"
                              data-toggle="tooltip"
                              data-placement="top"
                              title=""
                ...
                <div class="tab-content tabcontent-border">
                  <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="p-20">
                      ...
                      <img
                        src="../assets_form/images/background/img4.jpg"
                        class="img-fluid"
                      />
                    </div>
                  </div>
    ...
    <!-- Charts js Files -->
    <script src="../assets_form/libs/flot/excanvas.js"></script>
    <script src="../assets_form/libs/flot/jquery.flot.js"></script>
    <script src="../assets_form/libs/flot/jquery.flot.pie.js"></script>
    <script src="../assets_form/libs/flot/jquery.flot.time.js"></script>
    <script src="../assets_form/libs/flot/jquery.flot.stack.js"></script>
    <script src="../assets_form/libs/flot/jquery.flot.crosshair.js"></script>
    <script src="../assets_form/libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
    <script src="../dist_form/js/pages/chart/chart-page-init.js"></script>
  </body>
</html>
