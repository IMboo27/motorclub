      ...
      <div class="page-wrapper">
        ...
        <div class="container">
          <?php
            include'koneksi.php';
            $id_produk = $_GET['id'];
            $data = mysqli_query($koneksi,"SELECT * FROM produk_motor WHERE id_produk = '$id_produk'");
            while ($edit = mysqli_fetch_array ($data)) {
          ?>
            <form action="eg_aksi.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id_produk" value=<?=$edit['id_produk'];?> >
                <div class="mb-3">
                <label for="formFile" class="form-label">Masukkan file baru</label>
                <input class="form-control" type="file" name="img_produk" id="formFile" value="<?=$edit["img_produk"] ?>">
                </div>

                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Nama</label>
                    <input type="text" name="nama_produk" class="form-control" id="exampleInputPassword1" value="<?=$edit["nama_produk"] ?>">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Keterangan</label>
                    <input type="text" name="ket_produk" class="form-control" id="exampleInputPassword1" value="<?=$edit["ket_produk"] ?>">
                </div>
