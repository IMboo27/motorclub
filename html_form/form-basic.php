...
<html dir="ltr" lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="../assets_form/libs/select2/dist/css/select2.min.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="../assets_form/libs/jquery-minicolors/jquery.minicolors.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="../assets_form/libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css"
    />
    <link
      rel="stylesheet"
      type="text/css"
      href="../assets_form/libs/quill/dist/quill.snow.css"
    />
  ...
  <body>
    ...
    <script src="../assets_form/extra-libs/sparkline/sparkline.js"></script>
    <!--Wave Effects -->
    ...
    <!-- This Page JS -->
    <script src="../assets_form/libs/inputmask/dist/min/jquery.inputmask.bundle.min.js"></script>
    <script src="../dist_form/js/pages/mask/mask.init.js"></script>
    <script src="../assets_form/libs/select2/dist/js/select2.full.min.js"></script>
    <script src="../assets_form/libs/select2/dist/js/select2.min.js"></script>
    <script src="../assets_form/libs/jquery-asColor/dist/jquery-asColor.min.js"></script>
    <script src="../assets_form/libs/jquery-asGradient/dist/jquery-asGradient.js"></script>
    <script src="../assets_form/libs/jquery-asColorPicker/dist/jquery-asColorPicker.min.js"></script>
    <script src="../assets_form/libs/jquery-minicolors/jquery.minicolors.min.js"></script>
    <script src="../assets_form/libs/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <script src="../assets_form/libs/quill/dist/quill.min.js"></script>
    <script>
      //***********************************//
      // For select 2
      //***********************************//
