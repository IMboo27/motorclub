...
<main>
  ...
  <div class="slider-area position-relative">
    <div class="slider-active services-area pt-100 pb-150 section-bg" data-background="assets/img/gallery/m3.jpg"">
          <!-- Single Slider -->
        ...
        <div class="row">
          <div class="col-xl-7 col-lg-9 col-md-8 col-sm-9">
            <div class="hero__caption">
              <span data-animation="fadeInLeft" data-delay="0.1s">bersama tim kami</span>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12">
          <!-- about-img -->
          <div class="about-img">
            <img src="assets/img/gallery/m12.jpg" alt="" />
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="about-caption">
            ...
            <div class="section-tittle section-tittle3 mb-35">
              <span>ABOUT team kami</span>
              <h2>club motor ramah</h2>
            </div>
            <p class="pera-top">
              kami selalu mengingatkan satu sama lain agar tetap ramah, baik
              anak muda anggota baru maupun para sesepuh yang telah lama
              bergabung dengan kami. club ini diciptakan untuk bisa
              bersilahturahmi dan memperkuat tali persaudaraan.
            </p>
            <p class="mb-65 pera-bottom">
              Banyak diantara club motor yang arogan, namun disini semua ke
              arogansian akan hilang agar tidak mengganggu warga sekitar.
              hal ini yang membuat kita sadar bahwa perdamaian lebih indah
              daripada kerusuhan.
            </p>
          </div>
        </div>
  ...
  <!-- About-2 Area End -->
  <!--? Produk Area Start -->
  <section class="services-area pt-100 pb-150 section-bg" data-background="assets/img/gallery/m.jpg">
    <!--? Want To work -->
        ...
        <div class="row align-items-end justify-content-between">
          <div class="col-lg-6 col-md-10 col-sm-10">
            <div class="section-tittle section-tittle2">
              ...
              <h2>Kami menyediakan beberapa produk</h2>
            </div>
          </div>
          <div class="col-xl-2 col-lg-2 col-md-3">
            <a href="produk.html" class="btn wantToWork-btn f-right">Lihat selengkapnya</a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="single-cat text-center mb-50">
            <div class="cat-icon">
              ...
              <img src="assets/img/gallery/stiker.jpg" alt="" width="200px" height="130px">
            </div> <br>
            <div class="cat-cap">
              <h5><a href="produk.html">Stiker</a></h5>
              <p>Pasang stiker dari kami agar tampilan lebih keren dan menarik.</p><br> <br> <br>
            </div>
            <div class="img-cap">
              <a href="produk.html" class="">Lihat selengkapnya <i class="ti-arrow-right"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="single-cat text-center mb-50">
            <div class="cat-icon">
              <!-- <i class="flaticon-clock"></i> -->
              <img src="assets/img/gallery/baju.jpeg" alt="" width="200px" height="140px">
            </div> <br>
            <div class="cat-cap">
              <h5><a href="produk.html">Baju</a></h5>
              <p>Terlihat lebih gagah dengan memakai outfit kami, lebih bangga dengan produk lokal.</p>
            </div>
            <div class="img-cap">
              <a href="produk.html" class="">Lihat selengkapnya <i class="ti-arrow-right"></i></a>
            </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="single-cat text-center mb-50">
            <div class="cat-icon">
              <!-- <i class="flaticon-clock"></i> -->
              <img src="assets/img/gallery/mesin.png" alt="" width="200px">
            </div> <br>
            <div class="cat-cap">
              <h5><a href="produk.html">Mesin</a></h5>
              <p>Sebagai penikmatan motor anda agar lebih nyaman digunakan dan juga lebih terawat.</p>
            </div>
            <div class="img-cap">
              <a href="produk.html" class="">Lihat selengkapnya <i class="ti-arrow-right"></i></a>
            </div>
  ...
  <section class="services-area pt-100 pb-150 section-bg" data-background="assets/img/gallery/m4.jpg">
    <!--? Want To work -->
        ...
        <div class="row align-items-center">
          <div class="col-lg-5 col-md-11 col-sm-11">
            ...
            <div class="about-img2">
              <img src="assets/img/gallery/m13.jpg" alt="" />
              <!-- Shape -->
          ...
          <div class="col-lg-6 col-md-9 col-sm-9">
            <div class="about-caption">
              ...
              <div class="section-tittle mb-55">
                ...
                <h2>apa yang dipikirkan orang lain tentang kami?</h2>
              </div>
              <!-- Testimonial Start -->
              <div class="h1-testimonial-active">
                ...
                <div class="single-testimonial">
                  <div class="testimonial-caption">
                    <p>
                      Produk yang dijual sangat bagus, murah dan berkualitas tinggi.
                      ahitan rapi tidak gampang kusut dan tidak menyerap panas.
                    </p>
                    <div class="rattiong-caption">
                      <span style="color: white">Yuyuk wahyudi<span>Pembeli Pakaian</span>
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div class="single-testimonial">
                  <div class="testimonial-caption">
                    <p>
                      Motor saya lebih stabil dan lebih nyaman digunakan daripada sebelumnya.
                      Sungguh hebat mereka bisa mengcustom mesin dari mesin motor saya dan saya sangat puas.
                    </p>
                    <div class="rattiong-caption">
                      <span style="color: white">fernando<span>Pemeliharaan Mesin Motor</span> </span>
                    </div>
                  </div>
                </div>
                <div class="single-testimonial">
                  <div class="testimonial-caption">
                    <p>
                      Wow... Keren... <br> gambar yang didesain sangat cantik dan indah sertas tidak membosankan jika
                      dilihat terus-terusan.
                      <div class="rattiong-caption">
                        <span style="color: white">Dicky<span>Penikmat Desain</span> </span>
                      </div>
                  </div>
                </div>
              </div>
...
<footer>
  <!--? Footer Start-->
  <div class="footer-area section-bg" data-background="assets/img/gallery/m15.jpg">
    <div class="container">
